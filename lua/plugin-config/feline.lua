...
local function read_battery_value()
    ...
    return "B: " .. battery_value .. "%"
end

local function read_datetime()
...
table.insert(components.active[3], comps.os.battery)
table.insert(components.active[3], comps.os.datetime)
