...
map("n", "<Leader>fp", "<Cmd>Telescope packer<CR>", opts)
map("n", "<Leader>fs", "<Cmd>Telescope ultisnips<CR>", opts)
map("n", "<Leader>p", "<Cmd>Telescope oldfiles<CR>", opts)
map("n", "<C-p>", "<Cmd>Telescope project<CR>", opts)
-- map("n", "<Leader>a", "<Cmd>Telescope lsp_code_actions theme=cursor<CR>", opts)
map("n", "<Leader>ds", "<Cmd>Telescope lsp_document_symbols<CR>", opts)
map("n", "gr", "<Cmd>Telescope lsp_references<CR>", opts)
map("n", "<Leader>s", "<Cmd>Telescope sessions<CR>", opts)
map("n", "<Leader>gc", "<Cmd>Telescope git_commits<CR>", opts)
map("n", "<Leader>gf", "<Cmd>Telescope git_files<CR>", opts)
map("n", "<Leader>gb", "<Cmd>Telescope git_branches<CR>", opts)
map("n", "<Leader>fc", "<Cmd>Telescope neoclip<CR>", opts)
