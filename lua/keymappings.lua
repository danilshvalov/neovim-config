...
vim.api.nvim_set_keymap('n', 'gi', '<Cmd>lua vim.lsp.buf.implementation()<CR>',
                        opts)
vim.api
    .nvim_set_keymap('n', 'gf', '<Cmd>lua vim.lsp.buf.references()<CR>', opts)
...
vim.api.nvim_set_keymap('i', '<CR>', 'pumvisible() ? "<C-n><Esc>a" : "<CR>"',
                        {expr = true, noremap = true, silent = true})

-- formatting
vim.api.nvim_set_keymap('n', '<F3>', '<Cmd>Neoformat<CR>', opts)
...
-- saving
vim.api.nvim_set_keymap('n', '<D-s>', '<Cmd>w<CR>', opts)
